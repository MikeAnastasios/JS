...
function t2() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Mike')
    .then(data => {
        return data.text()
    })
    .then(data => {
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=15&num2=16')
    .then(data => {
        return data.text()
    })
    .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=1&num2=100')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=16&num2=16')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t9() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=9&y=1')
    .then(data => {
        return data.text();
    })
    .then(data => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body:'auth=DdC33D7d2C2a7&action=2&name=Mike',
    })
    .then(data => data.text())
    .then(data => {
...
function t12() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body:'auth=DdC33D7d2C2a7&action=3&num1=123&num2=456',
    })
    .then(data => data.text())
    .then(data => {
...
function t13() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body:'auth=DdC33D7d2C2a7&action=4&num1=123&num2=456',
    })
    .then(data => data.text())
    .then(data => {
...
function t15() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body:'auth=DdC33D7d2C2a7&action=6&num1=33&num2=33',
    })
    .then(data => data.text())
    .then(data => {
...
function t18() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body:'auth=DdC33D7d2C2a7&action=9&y=1',
    })
    .then(data => data.text())
    .then(data => {
