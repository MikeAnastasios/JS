...
function f4() {
    ...
    let funcOutput = document.querySelector('div.out-4');
    if (checkBox.checked) {
        funcOutput.innerHTML = true;
    }
    else {
        funcOutput.innerHTML = false;
    }
}
...
function f5() {
    ...
    let funcOutput = document.querySelector('div.out-5');
    if (checkBox.checked) {
        funcOutput.innerHTML = checkBox.value;
    }
    else {
        funcOutput.innerHTML = false;
    }
...
function f6() {
    ...
    document.querySelector('div.out-6').textContent = checkBox;
}
...
function f7() {
    ...
    document.querySelector('div.out-71').textContent = pass;
    let checkPass = document.querySelector('.out-72');
    if (pass.length >= 6) {
        checkPass.innerHTML = 1;
    }
    else {
        checkPass.innerHTML = 0;
    }
}
...
function f8() {
    let newDiv = document.querySelector('.out-8');
    newDiv.innerHTML = '<div class="js2">new div</div>';
}
...
function f9() {
    let radioButton = document.querySelector('.r-9');
    let station = document.querySelector('.out-9');
    if (radioButton.checked) {
        station.innerHTML = radioButton.value;
    }
    else {
        station.innerHTML = false;
    }
}
...
function f10() {
    let colorStyle = document.querySelector('.i-10').value;
    document.querySelector('.out-10').style.background = colorStyle;
}
...
function f11() {
    let colorStyle = document.querySelector('.i-111').value;
    document.querySelector('.i-112').value = colorStyle;
}
...
function f12() {
    let dateValue = document.querySelector('.i-12').value;
    document.querySelector('.out-12').textContent = dateValue;
}
...
function f13() {
    let sliderValue = document.querySelector('.i-13').value;
    document.querySelector('.out-13').innerHTML = sliderValue;
}
...
function f14() {
    ...
    document.querySelector('.out-14').innerHTML = textArea;
}
...
function f15() {
    let textArea = document.querySelector('.i-15').value;
    document.querySelector('.t-15').innerHTML = textArea;
    document.querySelector('.out-15').innerHTML = textArea;
}
...
function f16() {
    ...
    let numSelect = document.querySelector('.s-16').value;
    document.querySelector('.out-16').textContent = numSelect;
}
...
function f17() {
    let numSelect = document.querySelector('.s-17').value;
    document.querySelector('.out-17').textContent = numSelect;
}
...
function f18() {
    let inputOption = document.querySelector('.s-18').value;
    document.querySelector('.i-18').value = inputOption;
}
...
function f20() {
    let s1 = document.querySelector('.s-201').value;
    document.querySelector('.s-202').value = s1;
}
