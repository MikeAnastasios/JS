...
function t8() {
    ...
    document.querySelector('.out-8').textContent = data;// тут выводим
}
...
function t9() {
    let task9 = document.querySelector('.i-9').value;
    document.querySelector('.out-9').textContent = task9;
...
function t10() {
    let task10 = document.querySelector('.i-10').value;
    document.querySelector('.out-10').textContent = task10 * 20;
}
...
function t16() {
    ...
    document.querySelector('.out-16').textContent = +a1 + +a2;
}
...
function t19() {
    let a3 = document.querySelector('.i-19-1').value;
    let b3 = document.querySelector('.i-19-2').value;
    document.querySelector('.out-19').innerHTML = parseInt(a3) + parseInt(b3);
}
