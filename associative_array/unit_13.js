...
function f6() {
    let in61 = document.querySelector('.i-61').value;
    let in62 = document.querySelector('.i-62').value;
...
function f7() {
    let in7 = document.querySelector('.i-7').value;
    let out = '';
    if (a7[in7] !== undefined) {
        out = 1;
    }
...
function f12() {
    let in12 = document.querySelector('.i-12').value;
    for (let key in a12) {
    if (a12[key] == in12) {
        delete a12[key];
    }
