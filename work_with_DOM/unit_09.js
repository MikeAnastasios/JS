...
function f13() {
    ...
    thirteen.innerHTML = 'pushMe';
    thirteen.classList.add('bg-13');
    out.append(thirteen);
    thirteen.onclick = f13_1;
}
...
function f14() {
    ...
    fourteen.classList.add('bg-orange');
    out.append(fourteen);
}
...
function f15() {
    ...
    let fiveteen = document.createElement('div');
    fiveteen.innerHTML = 15;
    fiveteen.classList.add('bg-orange');
    out.before(fiveteen);
}
...
function f16() {
    ...
    sixteen.classList.add('bg-orange');
    out.after(sixteen);
}
...
function f17() {
    ...
    seventeen.innerHTML = 17;
    seventeen.classList.add('bg-orange');
    out.replaceWith(seventeen);
}
...
function f18() {
    ...
    let eightteen = document.querySelector('.p-18').getAttribute('data-b');
    out.innerHTML = eightteen;
}
...
function f19() {
    let finalOut = document.querySelector('.out-19');
    let nineteen = document.querySelectorAll('.p-19');
    let out = '';
    for (let i = 0; i < nineteen.length; i++) {
        out += nineteen[i].getAttribute('data-b') + '<br>';
    }
    finalOut.innerHTML = out;
}
...
function f20() {
    let twenty = document.querySelector('.out-20');
    twenty.setAttribute('title', 'go');
}
