...
let ar1 = ['Пётр', 'Семёнов', 25, true]// переменную обьявляем здесь!!!!
...
let ar2 = ['Шариковые ручки', 'Наклейки', 125, false] // переменную обьявляем здесь!!!!
...
let ar3 = [1, 2, 3, 4, 5]; // переменную обьявляем здесь!!!!
...
function f7() {
    // ar7.push('italy', 'turkey', 'vietnam'); - не отмечайте как ошибку, пожалуйста, просто гуглил и решил попробовать, сработало
    ar7[5] = 'italy';
    ar7[6] = 'turkey';
    ar7[7] = 'vietnam';
