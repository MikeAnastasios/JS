...
function t1() {
    let a1 = document.querySelector('.div-1').textContent;
...
function t4() {
    let a4 = document.querySelector('.div-4').textContent;
...
function t6() {
    let a6 = document.querySelector('.ul-6');
    a6.classList.toggle('hide');
}
...
let w2 = 75;
function t16() {
    document.querySelector('.div-16').style.width = w2 + 'px';
    w2++;
}
...
function t18() {
    ...
    a18.innerHTML = a18.clientWidth + 'px';
}
