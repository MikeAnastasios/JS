...
function f1() {
   let task1 = document.querySelector('.i-1').value;
...
function f4() {
   ...
   let enter = document.querySelector('.out-4');
   if (age >= 0 && age <= 2003) {
      enter.innerHTML = 1;
   }
   else {
...
function f5() {
   ...
   let enter = document.querySelector('.out-5');
   if (a < 0) {
      enter.innerHTML = 'm';
   }
   else if (a == 0) {
...
function f6() {
   ...
   let enter = document.querySelector('.out-6');
   if (a % 2 === 0) {
      enter.innerHTML = 'even';
   }
   else {
      enter.innerHTML = 'odd';
   }
...
function f8() {
   ...
   let enter = document.querySelector('.out-8');
   switch (select) {
      case 1:
         enter.innerHTML = 'one';
         break;
...
function f9() {
   ...
   let enter = document.querySelector('.out-9');
   if (a >= 1 && a <= 32) {
      enter.innerHTML = 1;
   }
   else if (a >= 33 && a <= 43) {
...
function f10() {
   ...
   let enter = document.querySelector('.out-10');
   switch (select) {
      case 6:
         enter.innerHTML = 6;
         break;
...
function f11() {
   ...
   let enter = document.querySelector('.out-11');
   switch (select) {
      case 6:
         enter.innerHTML = 6;
         break;
...
function f13() {
   ...
   // Полученный результат string, т.к. гипертекст не различает значения цифры, строки, булевские значения и т.д., он "видит" только строки.
}
...
function f14() {
   let x = +document.querySelector('.i-141').value;
   let y = +document.querySelector('.i-142').value;
   let z = document.querySelector('.s-143').value;
   let enter = document.querySelector('.out-14');
   switch (z) {
      case '+':
         enter.innerHTML = (x + y);
         break;
...
function f15() {
   let x = document.querySelector('.s-151').value;
   let y = document.querySelector('.s-152').value;
   let z = document.querySelector('.s-153').value;
   let enter = document.querySelector('.out-15');
   switch (z) {
      case '&&':
         enter.innerHTML = (x && y);
         break;
