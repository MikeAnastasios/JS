...
function t4() {
    div4.addEventListener('touchstart', f4)
}
function f4() {
...
function t5() {
    div4.removeEventListener('touchstart', f4);
}
...
function t10() {
    ...
    out10.innerHTML = document.querySelector('.div-10').style.width = w + 'px';
    w++;
}
...
function t11(event) {
    ...
    out11.innerHTML = event.changedTouches[0].radiusY + ', ' + event.changedTouches[0].radiusX;
}
