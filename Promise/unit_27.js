...
function t3() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=15&num2=15')
            .then(data => {
                resolve(data.text());
            })
    });
...
function t6() {
    let a = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=DdC33D7d2C2a7&action=3&num1=15&num2=16',
        })
            .then(data => {
                resolve(data.text());
            })
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=DdC33D7d2C2a7&action=4&num1=1&num2=100',
        })
            .then(data => {
                resolve(data.text());
            })
...
function t7() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php', {
            ...
            body: 'auth=DdC33D7d2C2a7&action=6&num1=15&num2=15',
        })
            .then(data => {
                resolve(data.text());
            })
